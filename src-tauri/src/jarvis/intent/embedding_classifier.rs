...
/// Generate a 256-dimensional semantic feature vector using character n-grams and hashing trick.
/// This provides sub-millisecond offline embedding computation with zero external dependencies.
pub fn embed_text(text: &str) -> Vec<f32> {
    ...
    // Unigrams, Bigrams, and Trigrams hashing
    for n in 1..=3 {
